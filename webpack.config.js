 ...
 */
// generated on 2018-01-04 using generator-openmrs-owa 0.6.0
'use strict';
...
var webpackConfig = {
  quiet: false,
  entry: {
	  app : `${__dirname}/app/js/insurerapp`,
	  css: `${__dirname}/app/css/insurerapp.css`,
	  vendor : [
