...
This repository contains the insurerapp OpenMRS Open Web App.
...
This will create a file called `insurerapp.zip` file in the `dist` directory,
...
This will build and deploy the app to the `/Users/larry/openmrs/refapp/owa`
...
```js
{
  "LOCAL_OWA_FOLDER": "/Users/larry/openmrs/refapp/owa"
}
```
...
{
  "LOCAL_OWA_FOLDER": "/Users/larry/openmrs/refapp/owa",
  "APP_ENTRY_POINT": "http://localhost:8080/openmrs/owa/insurerapp/index.html"
}
```
